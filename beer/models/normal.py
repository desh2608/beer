...
def _default_fullcov_param(mean, cov, prior_strength, tensorconf):
    ...
    prior = NormalWishartPrior.from_std_parameters(mean, scale, scale_matrix, dof)
    posterior = NormalWishartPrior.from_std_parameters(mean, scale, scale_matrix,
                                                  dof)
...
def _default_diagcov_param(mean, cov, prior_strength, tensorconf):
    ...
    prior = NormalGammaPrior.from_std_parameters(mean, scale, shape, rates)
    posterior = NormalGammaPrior.from_std_parameters(mean, scale, shape, rates)
    return ConjugateBayesianParameter(prior, posterior)
...
def _default_isocov_param(mean, cov, prior_strength, tensorconf):
    ...
    prior = IsotropicNormalGammaPrior.from_std_parameters(mean, scale, shape, rate)
    posterior = IsotropicNormalGammaPrior.from_std_parameters(mean, scale, shape,
                                                         rate)
    return ConjugateBayesianParameter(prior, posterior)
